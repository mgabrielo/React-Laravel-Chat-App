...
use HasFactory;
    ...
    public static function getConversationForSideBar(User $authUser){
            $users= User::getUsersExceptUser($authUser);
            $groups= Group::getGroupsForUser($authUser);
            // Log::info('Groups for user: ', $groups->toArray());
