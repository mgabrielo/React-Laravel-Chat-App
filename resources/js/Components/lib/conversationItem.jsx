...
const ConversationItem = ({
    ...
    return (
        <Link
            ...
            preserveState
            className={`conversation-item flex items-center gap-2 p-2 text-gray-300 
                        transition-all cursor-pointer border-l-4 hover:bg-black/30 border-b-[1px] border-b-gray-600
                    ${classes}
                    ${
